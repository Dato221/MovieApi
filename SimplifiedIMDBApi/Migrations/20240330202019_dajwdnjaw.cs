...
{
    /// <inheritdoc />
    public partial class dajwdnjaw : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesUser", x => new { x.MoviesMovieId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_MoviesUser_Movies_MoviesMovieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieUser", x => new { x.UserId, x.MovieId });
                    table.ForeignKey(
